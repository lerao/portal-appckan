...
class Ckan_client
{
	 ...
	 */
	public function __construct($baseUrlReceived, $api_versionReceived, $api_key = FALSE)
	{
		...
		$this->setApi_version($api_versionReceived);
		$this->setBaseUrlReceived($baseUrlReceived);
		$this->set_base_url();
		$this->set_user_agent();
		// Create cURL object.
		$this->ch = curl_init();
	...
	public function setBaseUrlReceived($base_url)
	{
		$this->base_url = $base_url . "/%d/";
	}
	...
	/**
	 * @access	public
	 * @return	array	An array of all package IDs - Fix para versões antigas.
	 * @since	Version 1
	 */
	public function get_dataset_register()
	{
		return $this->make_request_dataset('GET', $this->resources['dataset_register']);
	}
	 ...
	 * @since	Version 0.1.0
	 */
	public function get_group_dataset_register()
	{
		return $this->make_request_dataset('GET', $this->resources['group_register']);
	}
	...
	private function make_request_dataset($method, $url, $data = FALSE)
	{
		$ch = curl_init();
